...
class GlobalVars {
    ...
    static String INSTANCE_IP = "instanceIp"
    static String INSTANCE_ID = "instanceId"
    static String INSTANCE_URL = "instanceUrl"
    static String REGISTRY_URL = "registryUrl"

    static String CLOUD_CONTROL_AUTH_TOKEN = "jenkinsAuthorizationToken"
    static String CALLBACK_URL = "callbackUrl"
    static String WORKSPACE_ID = "WORKSPACE_ID"
    static String DEPLOYMENT_ID = "DEPLOYMENT_ID"
    ...
    static String BUCKET_NAME = "bucketName"
